...
public class Cpu extends Observable {
	...
	public Cpu() {
		IConfigurationElement[] config = Platform.getExtensionRegistry()
				.getConfigurationElementsFor(
						"com.objectsbydesign.calc.model.Value");// Change to fit
																// your own
		Object o = null;
		try {
			for (IConfigurationElement e : config) {
				System.out.println("Bharat Evaluating extension");
	...
	/**
	 * Enter numbers into the CPU. The CPU uses its current state to determine
	...
	public void pushOperation(Operation op) {
		...
		// compare precedence of new operation to the top of the stack (if not
		// empty)
		...
		IConfigurationElement[] config = Platform.getExtensionRegistry()
				.getConfigurationElementsFor(
						"com.objectsbydesign.calc.mode.Command");// Change to
																	// fit your
																	// own
		Object o = null;
		try {
			for (IConfigurationElement e : config) {
				System.out.println("Bharat Evaluating extension of command");
				o = e.createExecutableExtension("class");
			}
		} catch (CoreException ex) {
			System.out.println(ex.getMessage());
