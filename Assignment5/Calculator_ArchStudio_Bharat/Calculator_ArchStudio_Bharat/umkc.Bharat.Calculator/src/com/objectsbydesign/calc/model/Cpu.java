...
public class Cpu extends Observable {
    ...
    public void setCpuData(CalculatorArch calArch)
    {
    	System.out.println("Bharat Set Cpu Data");
    	 initialValue = calArch.OUT_Value;
    	 cmd = calArch.OUT_Command;
    ...
    /*
    public Cpu(CalculatorArch calArch) {
    	// Bharat changed here code to get value
        Value initialValue = calArch.OUT_Value;//new DecimalValue(0);
        cmd = calArch.OUT_Command;
        operandStack = new OperandStack();
        operationStack = new OperationStack();
        memory = new Memory(initialValue);
