...
public class CalculatorArch extends AbstractMyxSimpleBrick
{
    ...
    public void begin(){
        ...
        OUT_ICpu = (ICpu) MyxUtils.getFirstRequiredServiceObject(this,msg_ICpu);
        if (OUT_ICpu == null){
 			System.err.println("Error: Interface com.objectsbydesign.calc.model.ICpu returned null");
			return;       
        }
        _imp.begin();
    }
